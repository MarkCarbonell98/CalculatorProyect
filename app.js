let displaying = document.querySelector('#total');
let number = '';
let newNumber = '';
let operator = '';
let newOperator = '';
...
document.onload(() => {
    let numberLength = () => {
        if (numberLength > 26) {
            displaying.text(number.substr(number.length -26, 26));
            number = '';
            displaying.text('Err');
        }
    };
    document.querySelectorAll('#numbers a').addEventListener('click', () => {
        number = buttons.textContent();
...
/*$(document).ready(function () {
    let numberLength = function (number) {
        if (number.length > 26) {
            textDiv.text(number.substr(number.length -26, 26));
                number = '';
                textDiv.text('Err');
        }
    };
    ...
    $('#operators a').not('#decimal,#memory-plus,#memory-minus,#memory-reset,#memory-clear').click(function() {
        operator = $(this).text();
        newNumber = number;
        number = '';
        textDiv.text("0");
    ...
    $('#equals').click(function() {
        if (operator === '+') {
            ...
            if (textDiv.text() === number + decimal + decimal) {
                number = '';
                textDiv.text('Err');
            }
        }
 ...
 /*   $('#trigonometrics').click(function() {
        if (slid === 0) {
            $('#trigonometrics-menu').animate({
                margin-right: '200px',
                display: 'flex'
            }, 1500);
            slid++;
        } if (slid === 1) {
            $('#trigonometrics-menu').fadeOut(200);
            slid--;
        }
    });*/
// });
    ...
    /*$("#slidein").click(function(){
        $("#slide").hide('slide',{direction:'left'},200);
        if (slid === 1){
            $("#container").animate({"width": "330px"}, 250);
            $("#slide").animate({"margin-left": "325"})
        } else {
            $("#container").animate({"width": "548px"}, 250);
        }
        $("#slideout").show();
        $("#slidein").hide();
        slid--;*/
...
$(function() {
    ...
    $("#slideout").click(function(){
        if (slid === 0){
            $("#container").animate({"width": "548px"}, 200);
        } else {
            $("#container").animate({"width": "766px"}, 200);
            $("#slide").animate({"margin-left": "539"})
        }
        $("#slide").show('slide',{direction:'left'},250);
        $("#slidein").show();
        $("#slideout").hide();
        slid++;
    });
    $("#slidein2").click(function(){
        ...
        $("#calculator").animate({"margin-left": ""});
        $("#slideout2").show();
        $("#slidein2").hide();
        slid--;
    });
    $("#slideout2").click(function(){
        ...
        $("#calculator").animate({"margin-left": "213px"});
        $("#slide2").show('slide',{direction:'right'},250);
        $("#slidein2").show();
        $("#slideout2").hide();
        slid++;
    });
